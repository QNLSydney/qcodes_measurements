...
from pyqtgraph.multiprocess.remoteproxy import RemoteEventHandler, ClosedError, NoResultError, LocalObjectProxy, ObjectProxy
from pyqtgraph.util import cprint

__all__ = ['Process', 'QtProcess', 'ClosedError', 'NoResultError']
...
class Process(RemoteEventHandler):
    ...
    def __init__(self, name=None, target=None, debug=False, timeout=20):
        ...
        **Arguments:**
        ...
        pid = os.getpid() # we must send pid to child because windows only implemented getppid in Python 3.2
